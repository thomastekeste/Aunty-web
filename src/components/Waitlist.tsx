        ...
        {!submitted ? (
          ...
          >
            <input
              ...
              required
              className="flex-1 px-5 py-4 rounded-full bg-[rgba(255,255,255,0.06)] border border-[rgba(254,248,236,0.1)] text-[#FEF8EC] font-body placeholder:text-[rgba(254,248,236,0.25)] focus:outline-none focus:border-[#D4A04A] focus:ring-1 focus:ring-[#D4A04A]/30 transition-all"
            />
            <button
              type="submit"
              className="px-8 py-4 rounded-full bg-gradient-to-r from-[#D4A04A] to-[#B8862E] text-[#1A0F08] font-body font-bold hover:opacity-90 transition-opacity whitespace-nowrap shadow-lg shadow-[#D4A04A]/20"
            >
              Get Early Access
            </button>
          </form>
