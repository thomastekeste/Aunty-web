...
export const products: Product[] = [
  ...
  },
  {
    id: "electric-braider",
    sku: "H-023",
    name: "Electric Hair Braiding Tool",
    category: "tools",
    auntyId: "marcia",
    painPoint: "Salon-quality braids in minutes. No appointment, no sore arms.",
    price: 36,
    productType: "tool",
    keyIngredients: ["Automatic twist mechanism", "3-strand braiding", "USB-C rechargeable", "Portable"],
